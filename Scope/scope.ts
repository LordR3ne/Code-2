namespace Scope {
    class ScopeSuper {
        ...
        log(): void {
            console.group("Super");
            const x: string = "ScopeSuperMethod";
    ...
    class ScopeSub extends ScopeSuper {
        ...
        log(): void {
            console.group("Sub");
            const x: string = "ScopeSubMethod";              // Scope of method
            {
                const x: string = "ScopeSubMethodBlock";     // Scope of block
    ...
    const x: string = "Scope";                               // Scope of namespace
    const sub: ScopeSub = new ScopeSub();
    const sup: ScopeSuper = new ScopeSuper();
...
console.group("File");
const x: string = "File";                                 // Scope of file
Scope.log("File", x);
console.groupEnd();